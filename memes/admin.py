...
class ReportAdmin(admin.ModelAdmin):
    ...
    def mark_as_resolved(self, request, queryset):
        ...
        self.message_user(
            request, f"{updated} жалоб отмечено как рассмотренные.")
    ...
    def mark_as_unresolved(self, request, queryset):
        ...
        self.message_user(
            request,
            f"{updated} жалоб отмечено как нерассмотренные.")
...
class UserActivityAdmin(admin.ModelAdmin):
    ...
    def cleanup_old_logs(self, request, queryset):
        ...
        self.message_user(
            request,
            f"Удалено {deleted_count} старых записей логов (старше 90 дней)")
